...
test_script.readAHK("NovaScript/inputAHKScript")
...
test_script.writeNova("NovaScript/NovaTestScript")

# Write AHK script with plugged in values
test_script.writeAHK("NovaScript/outputAHKScript")

# Read in NovaScript
test_script.readNova("NovaScript/NovaTestScript.nova")
...
test_script.writeAHK("NovaScript/afterNovaRead")
